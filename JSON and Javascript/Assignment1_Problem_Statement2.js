//Assignment no 2 : Functional programming
var listOfPokemon = {
 "pokemon": [{
  "id": 1,
  "num": "001",
...
// Function displayPokemonInfo: Function to display complete Pokemon Information
var noErrorFlag0 = 0;

function displayPokemonInfo(name, anyarray) {
 for (x in anyarray.pokemon) {
  if (anyarray.pokemon[x].name == name) {
   noErrorFlag0 = noErrorFlag0 + 1;
   alert("ID : " + anyarray.pokemon[x].id + "\n" + "Num : " + anyarray.pokemon[x].num + "\n" + "Name : " + anyarray.pokemon[x].name + "\n" + "Img : " + anyarray.pokemon[x].img)
   for (i in anyarray.pokemon[x].type) {
    alert("Type " + i + " :" + anyarray.pokemon[x].type[i])
   }
   alert("Height : " + anyarray.pokemon[x].height + "\n" + "Weight : " + anyarray.pokemon[x].weight + "\n" + "Candy : " + anyarray.pokemon[x].candy + "\n" + "Candy_count : " + anyarray.pokemon[x].candy + "\n" +
    "Egg : " + anyarray.pokemon[x].egg + "\n" + "Spwan Chance : " + anyarray.pokemon[x].spawn_chance + "\n" + "Avg Spawns :" + anyarray.pokemon[x].avg_spawns + "\n" + "Spwan time :" + anyarray.pokemon[x].spawn_time)
   for (j in anyarray.pokemon[x].multipliers) {
    alert("Mulitpliers " + j + " :" + anyarray.pokemon[x].multipliers[j])
   }

   for (k in anyarray.pokemon[x].weakness) {
    alert("Weakness " + k + " :" + anyarray.pokemon[x].weakness[k])
   }

   for (l in anyarray.pokemon[x].prev_evolution) {
    alert("Previous Evolution Num :" + anyarray.pokemon[x].prev_evolution[l].num + "\n" +
     "Previous Evolution Name :" + anyarray.pokemon[x].prev_evolution[l].name)
   }

   for (m in anyarray.pokemon[x].next_evolution) {
    alert("Next Evolution Num  :" + anyarray.pokemon[x].next_evolution[m].num + "\n" +
     "Next Evolution Name :" + anyarray.pokemon[x].next_evolution[m].name + "\n")
   }
   break
  }
 }
...
displayPokemonInfo(name, listOfPokemon)

//Function to find out the names of all pokemons who have the Entered pokemon name in their next evolution field
var noErrorFlag1 = 0;

function findPokemonsNextEvolution(nextEvolName, anyarray) {
 for (x in anyarray.pokemon) {
  for (m in anyarray.pokemon[x].next_evolution) {
   if (anyarray.pokemon[x].next_evolution[m].name == nextEvolName) {
    alert("It is the Next Evolution of Pokemon :" + anyarray.pokemon[x].name)
    noErrorFlag1 = noErrorFlag1 + 1
    break
   }
 ...
 if (noErrorFlag1 == 0)
  alert("No Next Evolution available")


}

var nextEvolName = window.prompt("Enter the Next Evolution Pokemon Name")
findPokemonsNextEvolution(nextEvolName, listOfPokemon)


//Function to find out the names of all pokemons who have the Entered weakness
var noErrorFlag2 = 0;

function findPokemonsweaknesses(weaknesses, anyarray) {
 for (x in anyarray.pokemon) {
  for (a in anyarray.pokemon[x].weaknesses) {
   if (anyarray.pokemon[x].weaknesses[a] == weaknesses) {
    alert("It is the weaknesses of Pokemon :" + anyarray.pokemon[x].name)
    noErrorFlag2 = noErrorFlag2 + 1
    break
   }
 ...
 if (noErrorFlag2 == 0)
  alert("Enter valid weaknesses")

}

var weaknesses = window.prompt("Enter weakness")
findPokemonsweaknesses(weaknesses, listOfPokemon)